import { CompiledContract, ContractBytecodes, Request } from "../types";

import { AddBytecodes } from "../queries";
 ...
 */
export function* generateBytecodesLoad(contracts: CompiledContract[]):
